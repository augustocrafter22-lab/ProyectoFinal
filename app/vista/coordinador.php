...
<body>
    <header class="BarraNavegacion">
        ...
        <nav>
            ...
            <ul class="listaNavegacion">
                <li><a href="AdminUsuarios.html">Administrar usuarios</a></li>
    ...
    <section class="encabezado">
        <h1>Bienvendio, coordinador</h1>
    </section>
    <section class="modulo-imagen">
        <p>Haga uso del menu para comenzar.</p> 
        <img src="../Assets/Imagenes/UTU_9296-1024x614.jpg" alt="UTU_9296-1024x614" width="500px">
    </section>
    </body>
