...
<body>
    <main>
        <section class="SGRSI">
            <img src="../../public/assets/img/Isotipo-UTU-Color-Dorado-PNG.png" alt="DeKlan Enterprise" class="logo" width="200px" height="200px" />
            <h1>S.G.R.S.I.</h1>
            <p>Sistema de Gestión de Recursos y Soporte de Informática</p>
        </section>
        <section class="seccionLogin">
            <form action="../controlador/procesarLogin.php" method="POST" class="login-form" id="loginForm">
